from PyQt5.QtWidgets import QWidget, QFormLayout, QLineEdit, QPushButton, QMessageBox,QComboBox
...
class SettingsWindow(QWidget):
    def __init__(self):
        ...
        self.combo_sms_enabled.setCurrentText(
            current_sms_setting if current_sms_setting in ["فعال", "غیرفعال"] else "فعال")
    ...
    def save_settings(self):
        ...
        selected_unit = self.combo_currency.currentText()
        set_setting("currency_unit", selected_unit)
        sms_setting = self.combo_sms_enabled.currentText()
        set_setting("sms_enabled", sms_setting)
